    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="my-4 text-gray-900 dark:text-gray-100 flex gap-6 flex-wrap">
                    ...
                    <div class="bg-[#436850] relative rounded-[12px] w-52">
                        ...
                        <div class="px-3 py-1 text-right border-t-[1px] text-white ">
                            <a href="{{ route('data-kriteria-index') }}" class="text-sm text-center">Selengkapnya <i
                                    class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="bg-[#436850] relative rounded-[12px] w-52">
                        <div class="bg-[#D2E3C8] rounded-t-[12px] p-3 py-2">
                            <h4 class="font-bold text-lg text-[#436850]">Data Sub Kriteria</h4>
                        </div>
                        <div class="p-3">
                            <p class="text-white text-[28px] font-bold mb-6">{{ $jumlahSub }}</p>
                        </div>
                        <div class="px-3 py-1 text-right border-t-[1px] text-white ">
                    ...
                    <div class="bg-[#436850] relative rounded-[12px] w-52">
                        <div class="bg-[#D2E3C8] rounded-t-[12px] p-3 py-2">
                            <h4 class="font-bold text-lg text-[#436850]">Data Penilaian</h4>
                        </div>
                        <div class="p-3">
